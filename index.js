...
const PORT = process.env.PORT || 3001 // assigning a port for server

// Database Setup
const url = "mongodb+srv://Mahes:mahes12345@cluster0.oohqtlz.mongodb.net/?retryWrites=true&w=majority"; // Getting the mongo URL from the .env file
